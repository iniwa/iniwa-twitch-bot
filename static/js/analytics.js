(function() {
    ...
    window.sortStreamTable = sortStreamTable;
    ...
    window.highlightCalDay = highlightCalDay;
    window.unhighlightCalDay = unhighlightCalDay;
    window.setTimelineStartDate = setTimelineStartDate;
    window.updateYAxis = updateYAxis;
    window.adjustYAxisToVisible = adjustYAxisToVisible;
    window.resetYAxisRanges = resetYAxisRanges;
})();
